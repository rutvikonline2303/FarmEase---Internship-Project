...
<body  >
  ...
  <!-- Brand -->
  <a class="navbar-brand">Farmer Details</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    ...
    <li class="nav-item">
      ...
      <li class="nav-item">
        <a class="nav-link" href="farmerhome.php">Predictive Analysis</a>
      </li>
	  <li class="nav-item">
        <a class="nav-link" href="add.php">Add Product</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="index1.php">E-market</a>
      </li>
      <li class="nav-item">
...
<div class="container">
			...
			<div class=" bg-light mt-5 p-lg-3 rounded">
				<h2 class="text-center p-2">Fill below Farmer Information to Register</h2>
