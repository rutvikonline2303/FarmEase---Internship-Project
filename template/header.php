            ...
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <div class="header__logo text-center">
                        <a href="./index1.php"><img src="img/logo.png" alt="" style="border-radius:10px;width:200px;height:140px"></a>
                    </div>
                    <?php endif; ?>
                    <?php if($name != "" && $name != NULL): ?>
                        <div class="header__logo text-center">
                        <a href="./index1.php?name=<?= $name ?>&email=<?= $email ?>"><img src="img/logo.png" alt="" style="border-radius:10px;width:200px;height:140px">
                    </a>
                    </div>
                    <?php endif; ?>
                </div>
                <div class="col-lg-6">
                    <nav class="header__menu">
                        <ul>
                            ...
                            <li class=""><a href="./home.php">Farmease</a></li>                            
